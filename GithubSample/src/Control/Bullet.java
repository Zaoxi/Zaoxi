...
class Bullet0 extends Bullet implements Runnable {
	...
	public Bullet0(Tower _tower, Point towerRealPos, JLabel map_label, Control_Manager c) {
...
class Bullet1 extends Bullet implements Runnable {
	...
	public Bullet1(Tower _tower, Point towerRealPos, JLabel map_label, Control_Manager c) {
		super(_tower, DAMAGE, towerRealPos);
		bullet = new JLabel(imgBullet);
		effect = new JLabel(imgEffect);
		mapLabel = map_label;
...
class Bullet2 extends Bullet implements Runnable {
	...
	public Bullet2(Tower _tower, Point towerRealPos, JLabel map_label, Control_Manager c) {
		super(_tower, DAMAGE, towerRealPos);
		bullet = new JLabel(imgBullet);
		effect = new JLabel(imgEffect);
		mapLabel = map_label;
...
class Bullet3 extends Bullet implements Runnable {
	...
	public Bullet3(Tower _tower, Point towerRealPos, JLabel map_label, Control_Manager c) {
		super(_tower, DAMAGE, towerRealPos);
		bullet = new JLabel(imgBullet);
		effect = new JLabel(imgEffect);
		mapLabel = map_label;
...
class Bullet4 extends Bullet implements Runnable {
	...
	public Bullet4(Tower _tower, Point towerRealPos, JLabel map_label, Control_Manager c) {
		super(_tower, DAMAGE, towerRealPos);
		bullet = new JLabel(imgBullet);
		effect = new JLabel(imgEffect);
		mapLabel = map_label;
...
class Bullet5 extends Bullet implements Runnable {
	...
	public Bullet5(Tower _tower, Point towerRealPos, JLabel map_label, Control_Manager c) {
		super(_tower, DAMAGE, towerRealPos);
		bullet = new JLabel(imgBullet);
		effect = new JLabel(imgEffect);
		mapLabel = map_label;
